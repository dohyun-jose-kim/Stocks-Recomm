...
- **주의**: DB 파일이 GitHub 100MB 한도를 향해 성장 중 (#8보다 먼저 오는 데드라인) — [docs/KNOWN_LIMITATIONS.md](docs/KNOWN_LIMITATIONS.md), GCP 체험판 만료 대응은 [#8](https://github.com/dohyun-jose-kim/Stocks-Recomm/issues/8).
